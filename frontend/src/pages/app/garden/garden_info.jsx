        ...
        <MainPage title="Les informations du jardin" subtitle="Retrouvez ici toutes les informations concernant votre jardin">
            {isManager ? (<>
                ...
                < Form onSubmit={handleSubmit(onSubmit)} title="Informations" subtitle="Retrouvez ici toutes les informations concernant votre jardin" submitIsLoading={updateGarden.isLoading}>
                    <FormField register={register} name="gardenName" label="Nom du jardin" type="text" placeholder="Mon jardin" required={true} defaultValue={garden.name} />
                    ...
                    <FormField register={register} name="street-address" label="Adresse" type="text" placeholder="1 rue de la paix" required={true} defaultValue={garden.street_address} />

                    <FormField register={register} name="city" label="Ville" type="text" placeholder="Paris" required={true} defaultValue={garden.city} />

                    <FormField register={register} name="region" label="Région / Département" type="text" placeholder="Île-de-France" required={true} defaultValue={garden.province} />

                    <FormField register={register} name="postal-code" label="Code postal" type="text" placeholder="75000" required={true} defaultValue={garden.postal_code} />
                        ...
                        <div className="border-t border-gray-200 px-4 py-5 sm:p-0">
                            <dl className="sm:divide-y sm:divide-gray-200">
                                ...
                                <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:px-6">
                                    ...
                                    <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0"><img src={gardenPicture} alt="Preview" className="w-32 h-32 object-cover rounded-md" /></dd>
                                </div>
                                <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:px-6">
