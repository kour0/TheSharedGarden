                                ...
                                <form action="#" method="PATCH" onSubmit={handleSubmit(onSubmitProfile)}>
                                    <div className="shadow sm:overflow-hidden sm:rounded-md">
                                        ...
                                        <div className="bg-gray-50 px-4 py-3 text-right sm:px-6">
                                            <button
                                                type="submit"
                                                className={(updateProfile.isLoading ? "bg-gray-600" : "bg-teal-700 hover:bg-teal-800") + " inline-flex justify-center rounded-md border border-transparent py-2 px-4 text-sm font-medium text-white shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"} 
                            ...
                            <div className="mt-5 md:col-span-2 md:mt-0">
                                <form action="#" method="POST" onSubmit={handleSubmit(onSubmitPersonalInformation)}>
                                    <div className="overflow-hidden shadow sm:rounded-md">
                                        ...
                                        <button
                                                type="submit"
                                                className={(updatePersonalInformation.isLoading ? "bg-gray-600" : "bg-teal-700 hover:bg-teal-800") + " inline-flex justify-center rounded-md border border-transparent py-2 px-4 text-sm font-medium text-white shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"} 
