    ...
    <div className="relative overflow-hidden bg-white">
            ...
            <div className="relative px-4 pt-6 sm:px-6 lg:px-8">
              <nav className="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
                ...
                <div className="hidden md:ml-10 md:block md:space-x-8 md:pr-4">
                  ...
                  <Link to="/login" relative='path' className="font-medium text-teal-700 hover:text-teal-500">
                    Connexion
                  </Link>
                  <Link to="/register" relative='path' className="font-medium text-teal-700 hover:text-teal-500">
                    Inscription
                  </Link>
                </div>
              </nav>
          ...
          <main className="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block xl:inline">Créer ton jardin</span>{' '}
                <span className="block text-teal-600 xl:inline">et partage le</span>
              </h1>
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <img
          ...
          src="https://i.notretemps.com/1400x787/smart/2020/05/28/cinq-conseils-pour-un-potager-ideal.jpeg"
          alt=""
        />
      </div>
    </div>
